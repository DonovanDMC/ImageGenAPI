...
class ImageGenAPI {
	...
	constructor(options: {
		...
		Object.defineProperties(this, {
			...
			userAgent: {
				value:        options.userAgent || `ImageGenAPI/${pkg.version} (https://github.com/DonovanDMC/ImageGenAPI)`,
				enumerable:   false,
				configurable: false,
				writable:     false
			},
	...
	async request(path: string, avatars?: Array<string> | string, usernames?: Array<string> | string, text?: string, extra?: Record<string, string>): Promise<RequestResponse>;
	async request(path: string, avatars: Array<string> | string = [], usernames: Array<string> | string = [], text = "", extra: Record<string, string> = {}): Promise<RequestResponse | string> {
